...
export default function IconArrow({ width = 30, height = 30, color = "#272636", className="" } : IconProp) {
    ...
    return <svg t="1766316865887"  className={className} fill={color} width={width} height={height} viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6088">
